...
df_1=filter_dataframe(df, keys_1)
df_2=filter_dataframe(df, keys_2)
st.dataframe(df_1)
st.dataframe(df_2)
st.dataframe(df_1.describe().drop('std'))
st.dataframe(df_2.describe().drop('std'))
##st.bar(df_filt, x ='pvm', y='Neliohinta')
